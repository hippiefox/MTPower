...
public class MTNavigationBar: UIView {
    public var isContentAligmentCenterInVertical: Bool = false
    public var itemSpace: CGFloat = MTPowerConfig.default.nav_item_space
    public var leftItem: MTBarButtonItem? { didSet { leftItems = [leftItem] } }
    public var leftItems: [MTBarButtonItem?] = [] { didSet { setLeftItems(leftItems) } }
    public var rightItem: MTBarButtonItem? { didSet { rightItems = [rightItem] } }
    public var rightItems: [MTBarButtonItem?] = [] { didSet { setRightItems(rightItems) } }
    public var itemColor: UIColor = MTPowerConfig.default.nav_item_color {
        didSet {
            leftItems.forEach {
                if $0?.itemColor == nil {
    ...
    public var itemFont = MTPowerConfig.default.nav_item_font {
        didSet {
    ...
    public var shadowColor: UIColor = MTPowerConfig.default.nav_shadow_line_color { didSet { shadowView.backgroundColor = shadowColor } }
    public var bgAlpha: CGFloat = MTPowerConfig.default.nav_bg_alpha { didSet { backgroundView.alpha = bgAlpha } }
    public var bgColor: UIColor = MTPowerConfig.default.nav_bg_color { didSet { backgroundView.backgroundColor = bgColor } }
    public var leftAndRightSpace: CGFloat = MTPowerConfig.default.nav_content_hrz_inset
    ...
    public var titleColor: UIColor = MTPowerConfig.default.nav_title_color { didSet { titleLabel?.textColor = titleColor } }
    public var titleFont = MTPowerConfig.default.nav_title_font { didSet { titleLabel?.font = titleFont } }
...
extension MTNavigationBar {
    private func setLeftItems(_ items: [MTBarButtonItem?]) {
    ...
    private func setRightItems(_ items: [MTBarButtonItem?]) {
