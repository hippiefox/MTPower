...
open class MTProtoAlert: UIViewController {
    ...
    public var closeBlock: MTNullBlock?
    ...
    open lazy var closeButton: MTButton = {
        let btn = MTButton()
        btn.iconSize = .init(width: MT_Baseline(24), height: MT_Baseline(24))
...
extension MTProtoAlert {
    private func configureUI() {
        view.addSubview(containerView)
        
        containerView.frame = CGRect(x: 0, y: 0, width: MT_SCREEN_MIN_SIZE, height: MT_SCREEN_MIN_SIZE)
...
extension MTProtoAlert: UIGestureRecognizerDelegate {
...
extension MTProtoAlert: UIViewControllerTransitioningDelegate {
...
extension MTProtoAlert: UIViewControllerAnimatedTransitioning {
